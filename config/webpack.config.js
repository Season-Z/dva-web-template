...
// 不会开启 css modules
// antd 样式路径: D:\ypsx\ypshop-desktop-app-electron\node_modules\antd\lib\checkbox\style\index.less
// 坑：\node_modules 会被解析成 ode_modules :(
              ...
              use: getStyleLoaders(
                {
                  ...
                  modules: {
                    ...
                    getLocalIdent(context, _, className) {
                      ...
                      const cssPath = rootPath
                        .replace(projectPath + path.sep, '')
                        .replace('.less', '');
                      return `${cssPath.split(path.sep).join('-')}_${className}`; // eg: src-views-component_className
                    }
                  }
                },
                'less-loader'
